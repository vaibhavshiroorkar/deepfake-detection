...
STREAMS = {
    ...
    "views": [
        ...
        (
            "Lip-Sync",
            "AV-HuBERT over the mouth crop against Whisper over the audio, compared by "
            "cross-attention. Produces the synchronisation-mismatch vector. Stage 4.",
        ),
        (
            "Emotion",
            "HSEmotions over the face against Wav2Vec2 over the voice, same mechanism. "
...
LIPSYNC_STREAM = {
    ...
    "models": [
        (
            "AV-HuBERT",
            "video encoder. Reads mouth-region motion into an embedding (Key/Value)",
        ),
...
EMOTION_STREAM = {
    ...
    "models": [
        (
            "HSEmotions",
            "face-emotion encoder. Reads expression into an embedding (Key/Value)",
        ),
        (
            "Wav2Vec2",
...
FUSION = {
    ...
    "views": [
        ...
        (
            "Fusion MLP",
            "hidden sizes, dropout, and the resulting input dimension (streams x 256)",
        ),
...
EXPLAINABILITY = {
    ...
    "views": [
        ...
        (
            "Embedding shift",
            "which stream's embedding moves most on which manipulation type",
        ),
